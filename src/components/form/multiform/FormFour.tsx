...
return(
    <div className="flex flex-col gap-4">
        <input type="text" {...register("palabra-1", {required: true})} placeholder="Palabra" className="max-w-md p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"/>
